...
I'm an **Implementation Analyst and Full-Stack Developer** from Brazil, working at the intersection of software development, industrial operations, deployment, and technical support.

## What I work with

- **Frontend:** React, TypeScript, JavaScript, Vite, PWA, IndexedDB
- **Backend:** Node.js, Express, PostgreSQL, Prisma ORM, REST APIs, Zod, JWT
- **Infrastructure:** Docker, Nginx, Linux, Git/GitHub
- **Quality:** Playwright, Vitest
- **Other:** Python, SQL, QR Code workflows, offline-first synchronization, troubleshooting

## Production experience

I work on an industrial traceability platform used in a live paper manufacturing environment.
